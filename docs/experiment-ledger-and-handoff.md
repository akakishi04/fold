...
**docs/experiment-ledger-addendum-c183-c184.md**.
...
**C183 ACCEPTED PASS. C184 NOT REGISTERED. No active next experiment at acceptance.**
...
Localization is complete. Any input normalization must be a separately registered,
explicit hand-written local-index adapter,not a claim of learned invariance. Do not
mix internal counterfactual activations in deployment. No newC until acceptance saved.
