...
Write-Output "expected_focused_tests = 1846 (1813 existing +33 new); Gate_E = NOT_PASSED"
...
assert suite.countTestCases()==1846,f'Expected1846 tests, got{suite.countTestCases()}'
